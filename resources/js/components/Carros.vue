<template>
    <div class="container">
                    ...
                    <template v-slot:conteudo>
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input-container-component titulo="Matricula do Carro" id="inputMatricula" id-help="matriculaHelp" texto-ajuda="Opcional. Informe a matricula do carro">
                                    <input type="text" class="form-control" id="inputMatricula" aria-describedby="matriculaHelp" placeholder="Matricula do Carro" v-model="busca.placa">
                                </input-container-component>
                ...
                <card-component titulo="Relacao de Carros">
                    <template v-slot:conteudo>
                        <table-component 
                            ...
                            :visualizar="{visivel: true, dataToggle: 'modal', dataTarget:'#modalCarroVizualizar'}"
                            :actualizar="{visivel: true, dataToggle: 'modal', dataTarget:'#modalCarroActualizar'}"
        ...
        <modal-component id="modalCarro" titulo="Adicionar Marca">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <select-container-component titulo="Nome do Modelo" id="novoModelo" id-help="novoModeloHelp" texto-ajuda="Informe o nome do Modelo">
                        <select class="form-select" aria-label="Default select example" v-model="modeloId">
                ...
                <div class="form-group">
                    <input-container-component titulo="Matricula do Carro" id="novaMatricula" id-help="novaMatriculaHelp" texto-ajuda="Informe a Matricula do Carro">
                        <input type="text" class="form-control" id="novaMatricula" aria-describedby="novaMatriculaHelp" placeholder="Matricula do Carro" v-model="matricula">
                    </input-container-component>
                </div>
                <div class="form-group">
                    <input-container-component titulo="Disponibilidade" id="disponibilidade" id-help="disponibilidadeHelp" texto-ajuda="Disponivel?">
                        <input type="text" class="form-control" id="disponibilidade" aria-describedby="disponibilidadeHelp" placeholder="Disponivel?" v-model="disponibilidade">
                    </input-container-component>
                </div>
                <div class="form-group">
                    <input-container-component titulo="Km" id="km" id-help="kmHelp" texto-ajuda="Km?">
                        <input type="text" class="form-control" id="km" aria-describedby="kmHelp" placeholder="Km?" v-model="km">
                    </input-container-component>
                </div>
            </template>
            <template v-slot:rodape>
        ...
        <modal-component id="modalCarroActualizar" titulo="Actualizar Carro">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="Matricula do Carro" id="actualizarMatricula" id-help="actualizarMatriculaHelp" texto-ajuda="Informe a matricula do Carro">
                        <input type="text" class="form-control" id="actualizarMatricula" aria-describedby="actualizarMatriculaHelp" placeholder="Matricula do Carro" v-model="$store.state.item.placa">
                    </input-container-component>
                   
                </div>
                <div class="form-group">
                    <input-container-component titulo="Km" id="actualizarKm" id-help="actualizarKmHelp" texto-ajuda="Informe os kms do Carro">
                        <input type="text" class="form-control" id="actualizarKm" aria-describedby="actualizarKmHelp" placeholder="Km" v-model="$store.state.item.km">
                    </input-container-component>
