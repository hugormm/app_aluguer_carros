    ...
    <div class="container">
                    ...
                    <template v-slot:conteudo>
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input-container-component titulo="Numero de Portas" id="inputPortas" id-help="portasHelp" texto-ajuda="Opcional. Informe o numero de portas">
                                    <input type="text" class="form-control" id="inputPortas" aria-describedby="portasHelp" placeholder="Numero de Portas" v-model="busca.numero_portas">
                                </input-container-component>
                ...
                <card-component titulo="Relacao de Modelos">
                    <template v-slot:conteudo>
                        <table-component 
                            :dados="modelos.data"
                            :dadosFk="marcas.data"
                            :visualizar="{visivel: true, dataToggle: 'modal', dataTarget:'#modalModeloVizualizar'}"
                            :actualizar="{visivel: true, dataToggle: 'modal', dataTarget:'#modalModeloActualizar'}"
        ...
        <modal-component id="modalModelo" titulo="Adicionar Modelo">
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <select-container-component titulo="Nome da Marca" id="novoMarca" id-help="novoMarcaHelp" texto-ajuda="Informe o nome da Marca">
                        <select class="form-select" aria-label="Default select example" v-model="marcaId">
                ...
                <div class="form-group">
                    <input-container-component titulo="Numero de Portas" id="numeroPortas" id-help="numeroPortasHelp" texto-ajuda="Informe o numero de Portas">
                        <input type="text" class="form-control" id="numeroPortas" aria-describedby="numeroPortasHelp" placeholder="Numero de Portas" v-model="numeroPortas">
                    </input-container-component>
                </div>
                <div class="form-group">
                    <input-container-component titulo="Lugares" id="lugares" id-help="lugaresHelp" texto-ajuda="Informe o numero de lugares">
                        <input type="text" class="form-control" id="lugares" aria-describedby="lugaresHelp" placeholder="Numero de lugares" v-model="lugares">
                    </input-container-component>
                </div>
                <div class="form-group">
                    <input-container-component titulo="Air Bag" id="airBag" id-help="airBagHelp" texto-ajuda="Informe se tem Air Bag">
                        <input type="text" class="form-control" id="airBag" aria-describedby="airBagHelp" placeholder="Air Bag" v-model="airBag">
                    </input-container-component>
                </div>
                <div class="form-group">
                    <input-container-component titulo="Abs" id="abs" id-help="absHelp" texto-ajuda="Informe se tem Abs">
                        <input type="text" class="form-control" id="abs" aria-describedby="absHelp" placeholder="Abs" v-model="abs">
                    </input-container-component>
                </div>
            </template>
            <template v-slot:rodape>
        ...
        <modal-component id="modalModeloActualizar" titulo="Actualizar Modelo">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="Nome do Modelo" id="actualizarNome" id-help="actualizarNomeHelp" texto-ajuda="Informe o nome do Modelo">
                        <input type="text" class="form-control" id="actualizarNome" aria-describedby="actualizarNomeHelp" placeholder="Nome do Modelo" v-model="$store.state.item.nome">
                    </input-container-component>
                   
                </div>

                <div class="form-group">
                    <input-container-component titulo="Numero de Portas" id="actualizarNumeroPortas" id-help="actualizarNumeroPortasHelp" texto-ajuda="Informe o numero de portas">
                        <input type="text" class="form-control" id="actualizarNumeroPortas" aria-describedby="actualizarNumeroPortasHelp" placeholder="Numero de Portas" v-model="$store.state.item.numero_portas">
                    </input-container-component>
                   
                </div>
                <div class="form-group">
                    <input-container-component titulo="Numero de Lugares" id="actualizarNumeroLugares" id-help="actualizarNumeroLugaresHelp" texto-ajuda="Informe o numero de lugares">
                        <input type="text" class="form-control" id="actualizarNumeroLugares" aria-describedby="actualizarNumeroLugaresHelp" placeholder="Numero de Lugares" v-model="$store.state.item.lugares">
                    </input-container-component>
                   
                </div>
                <div class="form-group">
                    <input-container-component titulo="AirBag" id="actualizarAirBag" id-help="actualizarAirBagHelp" texto-ajuda="Informe se possui Air Bag">
                        <input type="text" class="form-control" id="actualizarAirBag" aria-describedby="actualizarAirBagHelp" placeholder="Air Bag" v-model="$store.state.item.airBag">
                    </input-container-component>
                   
                </div>
                <div class="form-group">
                    <input-container-component titulo="Abs" id="actualizarAbs" id-help="actualizarAbsHelp" texto-ajuda="Informe se possui Abs">
                        <input type="text" class="form-control" id="actualizarAbs" aria-describedby="actualizarAbsHelp" placeholder="Abs" v-model="$store.state.item.abs">
                    </input-container-component>
